...
#case "$REPLY" in
#1)
if [ -e /storage/c/enigma2/e2yaffs2.img ] && [ -e /storage/c/enigma2/uImage ]; then
...
#/storage/c/enigma2/bin/fw_setenv -s /storage/c/enigma2/etc/bootargs_evolux
#/storage/c/enigma2/bin/setmtdmode -l
#fi
#/storage/c/enigma2/bin/fw_printenv
echo "All Done!"
echo "Please turn off AC and select via FP-buttons bootup 'eng16-part' by:"
echo "ac off"
echo "ac on + hold ok-button till force on display"
echo "arrow down (eng16 on display)"
echo "ok-button (evolux should bootup)"
#sleep 10
#reboot -f
#else
#exit
