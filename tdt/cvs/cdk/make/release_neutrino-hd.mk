...
$(DEPDIR)/%release_neutrino-hd:
	...
	cp -dp $(targetprefix)/sbin/e2fsck $(prefix)/release_neutrino-hd/sbin/ && \
...
#	cp -dp $(buildprefix)/root/bin/evremote2.amiko $(prefix)/release_neutrino-hd/bin/
	...
	[ -d $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/wireless/rtl871x ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/wireless/rtl871x/8712u.ko $(prefix)/release_neutrino-hd/lib/modules/rt8712u.ko
	[ -d $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/wireless/rtl871x ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/wireless/rt2870sta/rt2870sta.ko $(prefix)/release_neutrino-hd/lib/modules/
	[ -d $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/wireless/rt3070sta ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/wireless/rt3070sta/rt3070sta.ko $(prefix)/release_neutrino-hd/lib/modules/
	[ -d $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/wireless/rt5370sta ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/wireless/rt5370sta/rt5370sta.ko $(prefix)/release_neutrino-hd/lib/modules/
...
#	[ -d $(targetprefix)/lib/modules/$(KERNELVERSION)/kernel/drivers/media/dvb/frontends ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/kernel/drivers/media/dvb/frontends/* $(prefix)/release_neutrino-hd/lib/modules/
	[ -d $(targetprefix)/lib/modules/$(KERNELVERSION)/kernel/drivers/net ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/kernel/drivers/net/tun.ko $(prefix)/release_neutrino-hd/lib/modules/
	[ -d $(targetprefix)/lib/modules/$(KERNELVERSION)/kernel/drivers/input/misc ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/kernel/drivers/input/misc/uinput.ko $(prefix)/release_neutrino-hd/lib/modules/
	[ -d $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/cec ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/cec/cec.ko $(prefix)/release_neutrino-hd/lib/modules/
...
#######################################################################################
	...
	( cd $(prefix)/release_neutrino-hd/usr/local/bin/ && ln -sf ../../../bin/mhwepg mhwepg )
...
#	TODO: HACK
	...
	mv $(prefix)/release_neutrino-hd/usr/local/share/config/Sportster.conf $(prefix)/release_neutrino-hd/usr/local/share/neutrino/themes/Sportster.theme
#######################################################################################
...
#######################################################################################
	echo "evolux-sh4-rev#: " > $(prefix)/release_neutrino-hd/etc/imageinfo
...
#	cp $(kernelprefix)/$(kernelpath)/arch/sh/boot/uImage $(prefix)/release_neutrino-hd/boot/
	...
	cp -RP $(buildprefix)/root/bin/grab $(prefix)/release_neutrino-hd/bin/
	cp -a $(buildprefix)/root/usr/bin/amixer $(prefix)/release_neutrino-hd/usr/bin/
	find $(prefix)/release_neutrino-hd/usr/bin/ -name 'amixer' -exec sh4-linux-strip --strip-unneeded {} \;
...
#	cp -RP $(targetprefix)/usr/bin/blockad $(prefix)/release_neutrino-hd/bin/
	...
	cp -RP $(appsdir)/neutrino-hd-plugins/tuxcom/tuxcom $(prefix)/release_neutrino-hd/var/plugins/tuxcom.so
	cp -RP $(appsdir)/neutrino-hd-plugins/tuxcom/tuxcom.cfg $(prefix)/release_neutrino-hd/var/plugins/
...
#	[ -e $(kernelprefix)/$(kernelpath)/fs/ntfs/ntfs.ko ] && cp $(kernelprefix)/$(kernelpath)/fs/ntfs/ntfs.ko $(prefix)/release_neutrino-hd/lib/modules || true
	...
	[ -e $(targetprefix)/lib/modules/$(KERNELVERSION)/kernel/fs/autofs4/autofs4.ko ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/kernel/fs/autofs4/autofs4.ko $(prefix)/release_neutrino-hd/lib/modules/ || true
