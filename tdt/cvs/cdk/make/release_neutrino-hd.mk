...
#######################################################################################
	...
	cp $(targetprefix)/bin/mhwepg $(prefix)/release_neutrino-hd/usr/local/bin/
...
#	rm $(prefix)/release_neutrino-hd/bin/mount
	...
	[ -e $(buildprefix)/root/usr/local/share/neutrino/nhttpd/Y_Boxcontrol_Menue.yhtm.dirty-fix ] && cp -RP $(buildprefix)/root/usr/local/share/neutrino/Y_Boxcontrol_Menue.yhtm.dirty-fix $(prefix)/release_neutrino-hd/usr/local/share/neutrino/httpd/Y_Boxcontrol_Menue.yhtm
	[ -e $(buildprefix)/root/usr/local/share/neutrino/nhttpd/Y_Tools_fbshot.yhtm.dirty-fix ] && cp -RP $(buildprefix)/root/usr/local/share/neutrino/nhttpd/Y_Tools_fbshot.yhtm.dirty-fix $(prefix)/release_neutrino-hd/usr/local/share/neutrino/httpd/Y_Tools_fbshot.yhtm
	[ -e $(buildprefix)/root/usr/local/share/neutrino/nhttpd/scripts/Y_Tools.sh.dirty-fix ] && cp -RP $(buildprefix)/root/usr/local/share/neutrino/nhttpd/scripts/Y_Tools.sh.dirty-fix $(prefix)/release_neutrino-hd/usr/local/share/neutrino/httpd/scripts/Y_Tools.sh.dirty-fix
