...
$(DEPDIR)/%release_evolux_pli:
	...
	mkdir -p $(prefix)/release_evolux_pli_with_dev
	$(USERS) cp -RP $(prefix)/release_neutrino_with_dev/* $(prefix)/release_evolux_pli_with_dev/
	$(USERS) chmod 777 -R $(prefix)/release_evolux_pli_with_dev
	...
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/usr/local $(prefix)/release_evolux_pli_with_dev/usr/
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/network/interfaces $(prefix)/release_evolux_pli_with_dev/etc/network/
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/dropbear $(prefix)/release_evolux_pli_with_dev/etc/
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/enigma2 $(prefix)/release_evolux_pli_with_dev/etc/
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/fonts $(prefix)/release_evolux_pli_with_dev/etc/
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/tuxbox $(prefix)/release_evolux_pli_with_dev/etc/
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/Wireless $(prefix)/release_evolux_pli_with_dev/etc/
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/changelog.txt $(prefix)/release_evolux_pli_with_dev/etc/
	echo "EvoLux" > $(prefix)/release_evolux_pli_with_dev/etc/hostname
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/image-version $(prefix)/release_evolux_pli_with_dev/etc/
	...
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/rc.d/rc3.d $(prefix)/release_evolux_pli_with_dev/etc/rc.d/
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/rc.d/rc6.d $(prefix)/release_evolux_pli_with_dev/etc/rc.d/
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/etc/init.d/ntpupdate.sh $(prefix)/release_evolux_pli_with_dev/etc/init.d/
	cp -RP $(buildprefix)/root/etc/init.d/DisplayTime.sh $(prefix)/release_evolux_pli_with_dev/etc/init.d/
	cp -RP $(buildprefix)/root/release/rcS_stm23_24_evolux_spark $(prefix)/release_evolux_pli_with_dev/etc/init.d/rcS
	cp -RP $(prefix)/release-enigma2-pli-nightly_with_dev/lib/modules $(prefix)/release_evolux_pli_with_dev/lib/
	if [ -e $(targetprefix)/usr/share/alsa ]; then \
		cp -RP $(targetprefix)/usr/share/alsa $(prefix)/release_evolux_pli_with_dev/usr/share/; \
	fi
#	cp -RP $(prefix)/release_evolux_pli_with_dev/boot/uImage $(prefix)/
	cp -RP $(targetprefix)/boot/uImage $(prefix)/
	( cd $(prefix) && cd ../flash/spark/orig-spark-plugin/root/plugin/var/etc && cp * $(prefix)/release_evolux_pli_with_dev/etc/ )
	cp -RP $(buildprefix)/root/bin/fw_printenv $(prefix)/release_evolux_pli_with_dev/bin/
	cp -RP $(buildprefix)/root/bin/fw_setenv $(prefix)/release_evolux_pli_with_dev/bin/
	...
	( cd $(prefix) && cp -RP ../flash/spark/spark_oob.img $(prefix)/release_evolux_pli_with_dev/sbin/ )
