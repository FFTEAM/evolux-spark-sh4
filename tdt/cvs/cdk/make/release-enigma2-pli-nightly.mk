...
if ENABLE_P0210
	...
	[ -f $(driverdir)/lib/modules/$(KERNELVERSION)/extra/cec/enigma2-plugin/plugin.py ] && cp -RP $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/cec/enigma2-plugin $(prefix)/release-enigma2-pli-nightly/usr/lib/enigma2/python/plugins/Extensions/cec
...
#	echo 'sda3   -fstype=auto,noatime,nodiratime          :/dev/sda3' >> $(prefix)/release-enigma2-pli-nightly/etc/auto.usb
	...
	cp -RP $(targetprefix)/usr/lib/libopkg*.so* $(prefix)/release-enigma2-pli-nightly/usr/lib/
