...
if ENABLE_P0210
	...
	[ -f $(driverdir)/lib/modules/$(KERNELVERSION)/extra/cec/enigma2-plugin ] && cp -RP $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/cec/enigma2-plugin $(prefix)/release-enigma2-pli-nightly/usr/lib/enigma2/python/plugins/Extensions/cec
