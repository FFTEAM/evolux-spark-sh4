...
release-enigma2-pli-nightly_spark:
	echo "spark" > $(prefix)/release-enigma2-pli-nightly/etc/hostname
	rm -f $(prefix)/release-enigma2-pli-nightly/sbin/halt
	...
	cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/frontends/lnb/lnb.ko $(prefix)/release-enigma2-pli-nightly/lib/modules/
...
if ENABLE_PLAYER191
	...
	ln -sf /usr/local/share/enigma2 $(prefix)/release-enigma2-pli-nightly/usr/share/enigma2
...
#       Font libass
	...
	if [ -e $(targetprefix)/usr/bin/enigma2 ]; then \
		cp -f $(targetprefix)/usr/bin/enigma2 $(prefix)/release-enigma2-pli-nightly/usr/local/bin/enigma2;fi
	if [ -e $(targetprefix)/usr/local/bin/enigma2 ]; then \
		cp -f $(targetprefix)/usr/local/bin/enigma2 $(prefix)/release-enigma2-pli-nightly/usr/local/bin/enigma2;fi
...
######## FOR YOUR OWN CHANGES use these folder in cdk/own_build/enigma2 #############
	...
	[ -e $(kernelprefix)/linux-sh4/fs/fuse/fuse.ko ] && cp $(kernelprefix)/linux-sh4/fs/fuse/fuse.ko $(prefix)/release-enigma2-pli-nightly/lib/modules || true
	...
	[ -e $(kernelprefix)/linux-sh4/fs/cifs/cifs.ko ] && cp $(kernelprefix)/linux-sh4/fs/cifs/cifs.ko $(prefix)/release-enigma2-pli-nightly/lib/modules || true
	...
	[ -e $(kernelprefix)/linux-sh4/fs/jfs/jfs.ko ] && cp $(kernelprefix)/linux-sh4/fs/jfs/jfs.ko $(prefix)/release-enigma2-pli-nightly/lib/modules || true
	[ -e $(kernelprefix)/linux-sh4/fs/nfsd/nfsd.ko ] && cp $(kernelprefix)/linux-sh4/fs/nfsd/nfsd.ko $(prefix)/release-enigma2-pli-nightly/lib/modules || true
	[ -e $(kernelprefix)/linux-sh4/fs/exportfs/exportfs.ko ] && cp $(kernelprefix)/linux-sh4/fs/exportfs/exportfs.ko $(prefix)/release-enigma2-pli-nightly/lib/modules || true
	[ -e $(kernelprefix)/linux-sh4/fs/nfs_common/nfs_acl.ko ] && cp $(kernelprefix)/linux-sh4/fs/nfs_common/nfs_acl.ko $(prefix)/release-enigma2-pli-nightly/lib/modules || true
	[ -e $(kernelprefix)/linux-sh4/fs/nfs/nfs.ko ] && cp $(kernelprefix)/linux-sh4/fs/nfs/nfs.ko $(prefix)/release-enigma2-pli-nightly/lib/modules || true
