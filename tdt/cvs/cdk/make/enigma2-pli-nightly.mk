...
$(appsdir)/enigma2-pli-nightly/config.status: bootstrap freetype expat fontconfig libpng jpeg libgif libfribidi libid3tag libmad libsigc libreadline \
		libdvbsipp python libxml2 libxslt elementtree zope_interface twisted pyopenssl lxml libxmlccwrap ncurses-dev libdreamdvd2 tuxtxt32bpp sdparm gstreamer gst_plugins_dvbmediasink gst_plugins_bad gst_plugins_fluendo_mpegdemux gst_ffmpeg enigma2-pli-plugins $(EXTERNALLCD_DEP)
