...
#	[ -d $(targetprefix)/lib/modules/$(KERNELVERSION)/kernel/drivers/media/dvb/frontends ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/kernel/drivers/media/dvb/frontends/* $(prefix)/release_neutrino/lib/modules/
	...
	[ -f $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/cec/cec.ko ] && cp $(targetprefix)/lib/modules/$(KERNELVERSION)/extra/cec/cec.ko $(prefix)/release_neutrino/lib/modules/
...
#	TODO: HACK
	cp -aR $(targetprefix)/usr/local/share/neutrino/* $(prefix)/release_neutrino/usr/local/share/neutrino
#######################################################################################
...
#######################################################################################
	echo "evolux-sh4-rev#: " > $(prefix)/release_neutrino/etc/imageinfo
	git describe --always >> $(prefix)/release_neutrino/etc/imageinfo
...
#	rm $(prefix)/release_neutrino/usr/lib/tuxbox/plugins/blockad*
	...
	if [ -e $(targetprefix)/usr/share/alsa ]; then \
		cp -RP $(targetprefix)/usr/share/alsa $(prefix)/release_neutrino/usr/share/; \
	fi
if ENABLE_MULTI_YAFFS2
	...
	[ -e $(prefix)/release_neutrino/for_your_own_changes ] && rm $(prefix)/release_neutrino/for_your_own_changes
	[ -e $(kernelprefix)/$(kernelpath)/drivers/net/wireless/ath/ath.ko ] && cp $(kernelprefix)/$(kernelpath)/drivers/net/wireless/ath/ath.ko $(prefix)/release_neutrino/lib/modules/ath.ko || true
