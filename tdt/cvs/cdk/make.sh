...
echo "---------------------------------"
echo "make evolux-neutrino-hd-pli"
echo "make evolux-neutrino-hd-pli-full"
echo "---------------------------------"
echo "make evolux-neutrino-hd2"
echo "make evolux-neutrino-hd2-full"
echo "---------------------------------"
echo "make evolux-neutrino-hd2-pli"
echo "make evolux-neutrino-hd2-pli-full"
echo "---------------------------------"
