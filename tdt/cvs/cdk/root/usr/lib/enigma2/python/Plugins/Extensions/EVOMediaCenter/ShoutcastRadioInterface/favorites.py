from Plugins.Extensions.EVOMediaCenter.EVOMC_ShoutcastStreamInterface import StreamInterface, Stream
from Plugins.Extensions.EVOMediaCenter.EVOMC_ShoutcastRadio import myname
