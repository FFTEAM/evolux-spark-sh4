...
class dirSelectDlg(Screen): # 90,140
	skin = """
		<screen name="dirSelectDlg" position="center,center" size="560,360">
			...
			<widget name="ButtonOK" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/JobManager/ok.png" position="30,330" zPosition="10" size="35,25" transparent="1" alphatest="on" />
		</screen>"""
