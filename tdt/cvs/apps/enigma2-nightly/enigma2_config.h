...
/* Define to 1 if you have the <dbox/fp.h> header file. */
#define HAVE_DBOX_FP_H 1

/* Define to 1 if you have the <dbox/lcd-ks0713.h> header file. */
#define HAVE_DBOX_LCD_KS0713_H 1
