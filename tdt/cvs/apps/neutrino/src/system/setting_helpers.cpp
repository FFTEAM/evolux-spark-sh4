...
const CMenuOptionChooser::keyval USERMENU_ITEM_OPTIONS[USERMENU_ITEM_OPTION_COUNT] =
{
        ...
        {SNeutrinoSettings::ITEM_EMU_RESTART, LOCALE_EXTRAMENU_EMU_RESTART} ,
        {SNeutrinoSettings::ITEM_TUNER_RESTART, LOCALE_EXTRAMENU_TUNERRESET_RESTART} 
#if 0
...
int CUserMenuMenu::exec(CMenuTarget* parent, const std::string & actionKey)
{
        ...
        CMenuWidget menu (local , "keybinding");
