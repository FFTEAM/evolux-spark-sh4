...
const char *locale_real_names[] = {
	...
	"extramenu.emu.mboxversion",
	"extramenu.emu.oscamversion",
	"extramenu.emu.spcsversion",
	"extramenu.emu.newcsversion",
	"extramenu.swap",
	...
	"extramenu.extdisplay",
	"extramenu.extdisplay.select",
	"extramenu.extdisplay.on",
	"extramenu.extdisplay.off",
	"setting.saved",
	"play.button.action",
