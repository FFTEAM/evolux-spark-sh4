...
extern int YWPANEL_FP_ControlTimer(int on);
extern u32  YWPANEL_FP_GetTime(void);
extern int YWPANEL_FP_SetTime(u32 value);
extern u32  YWPANEL_FP_GetStandByKey(u8 index);
extern int YWPANEL_FP_SetStandByKey(u8 index, u8 key);
extern u32  YWPANEL_FP_GetBlueKey(u8 index);
extern int YWPANEL_FP_SetBlueKey(u8 index,u8 key);

extern u32  YWPANEL_FP_GetIRKey(void);
extern int YWPANEL_FP_SetPowerOnTime(u32 Value);
extern u32  YWPANEL_FP_GetPowerOnTime(void);
int  YWPANEL_FP_SetCpuStatus(u32 state);
