...
#if defined(ST_7101) || defined(CONFIG_CPU_SUBTYPE_STX7105) || defined(CONFIG_CPU_SUBTYPE_STB7100) || defined(CPU_SUBTYPE_STX7100) || defined(CONFIG_CPU_SUBTYPE_STX7111)
...
#if defined(A18) || defined(REL23) || defined(REL29)
...
typedef volatile struct TCGlobalInfo_s
{
...
#if defined(SECURE_LITE2) && defined(A18)
...
#if defined(SECURE_LITE2) && (defined(REL23) || defined(REL29))
    u16 GlobalLastTickSessionNumber;     /* (TC )  */
    u16 GlobalTickEnable;                /* (Host) */
    ...
    u16 GlobalLastTickSlotNumber;        /* (TC )  */
    u16 GlobalFRPFirstStatBlkFlag;       /* (TC )  */

    u16 GlobalLast16ByteBlockStart;      /* (TC )  */
    u16 GlobalResidueStart;              /* (TC )  */
#endif
...
#if defined(SECURE_LITE2) && (defined(A18) || defined(REL23) || defined(REL29))
...
#elif defined(A18) || defined(REL23)
